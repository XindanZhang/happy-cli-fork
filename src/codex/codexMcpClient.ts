...
import { CodexElicitationCreateRequestSchema, codexElicitationResponseForDecision } from './utils/codexElicitation';
        ...
        this.client.setRequestHandler(
            ...
            async (request) => {
                    ...
                    switch (codexElicitationType) {
                        case 'exec-approval':
                            return {
                                ...
                                parsed_cmd: params.codex_parsed_cmd,
                ...
                try {
                    ...
                    return codexElicitationResponseForDecision(result.decision);
                } catch (error) {
